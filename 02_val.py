...
def run(
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        t3 = time_sync()
        out = non_max_suppression(out, conf_thres, iou_thres, labels=lb, multi_label=True, agnostic=single_cls)  # Rane 非极大值抑制算法在这里
        dt[2] += time_sync() - t3
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp_dumei_type0-2_ip12123_v3/weights/best.pt', help='model.pt path(s)')
